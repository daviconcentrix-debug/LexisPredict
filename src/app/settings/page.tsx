...
import { Settings, Shield, User, Bell, Database, HardDrive } from 'lucide-react';
            ...
            <div className="md:col-span-3 space-y-8">
              ...
              <Card className="bg-card border-border">
                <CardHeader>
                  ...
                  <CardDescription>Management of your local and cloud database storage.</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="flex items-center justify-between p-4 bg-secondary/30 rounded-xl border border-border">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-bold text-white">Local Storage Usage</p>
                        <p className="text-xs text-muted-foreground">Currently utilizing 42% of allowed cache (2.1MB)</p>
                      </div>
                    </div>
                    <Button variant="outline" size="sm" className="text-[10px] font-bold uppercase tracking-widest border-border">Optimize</Button>
                  </div>
                </CardContent>
              </Card>
            </div>
