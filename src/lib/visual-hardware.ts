...
/**
 * MOTOR DE HARDWARE VISUAL v175000.0 ELITE
 * Gerencia opacidade, blur e injeção de variáveis de estilo no root.
 */
  ...
  return new Promise((resolve, reject) => {
    ...
    reader.onload = () => {
      ...
      try {
        ...
        // Se exceder a quota do LS, limpamos mas o IndexedDB já salvou o blob
        localStorage.removeItem("lexisPredict_wallpaper");
      }
